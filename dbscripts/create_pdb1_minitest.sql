...
begin
  ...
  dbms_saga_adm.add_coordinator(coordinator_name => 'MBCoordinator', mailbox_schema => 'pdb_adm', broker_name => 'MBBroker', dblink_to_coordinator => 'pdb1_link');
  dbms_saga_adm.add_participant(participant_name => 'MBInitiator',   coordinator_name => 'MBCoordinator' ,   dblink_to_broker => null ,   mailbox_schema => 'pdb_adm' ,   broker_name => 'MBBroker' ,   callback_package => 'mb_cbk' ,   dblink_to_participant => null);
end;
